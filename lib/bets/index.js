/**
 * @module lib/bets
 * @description Provides a generic bet interace for the user that can be called from games via the 'start' function.
 * @example
 *  var Bets = require('lib/bets');
 *  var bets = new Bets(100);
 ...
 *  });
 *
 * @todo GREARLY improve user interface
 * @todo provide persistent storage of winnings
 * @todo on-hand winnings (can't go below 0) vs. bank winnings (all-time, can go negative)
 */
'use strict';
